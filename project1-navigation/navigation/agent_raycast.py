...
_AGENT_CONFIG.epsilonEnd                 = 0.01
_AGENT_CONFIG.epsilonDecay               = 0.999
_AGENT_CONFIG.lr                         = 0.001
_AGENT_CONFIG.minibatchSize              = 64
_AGENT_CONFIG.learningStartsAt           = 0
_AGENT_CONFIG.learningUpdateFreq         = 10
_AGENT_CONFIG.learningUpdateTargetFreq   = 10
_AGENT_CONFIG.learningMaxSteps           = 4000
_AGENT_CONFIG.replayBufferSize           = 400000
_AGENT_CONFIG.discount                   = 0.999
